...
export function ProposalCardSocial({ proposal }: ProposalCardSocialProps) {
  ...
  return (
    <div className="glass-card glass-card-hover rounded-xl p-6 relative overflow-hidden">
      ...
      <Link to={`/proposal/${proposal._id}`}>
        <Button className="w-full bg-gradient-purple-cyan hover:opacity-90 transition-opacity font-semibold">
          View Proof & Execute
        </Button>
      </Link>
    </div>
