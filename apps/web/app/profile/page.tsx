...
export default function ProfilePage() {
  ...
  // Form State - [FIX 3] Đã xóa Risk & Trade Style
  ...
  const handleSyncBalances = async () => {
    ...
    try {
      ...
      toast.success('Wallet balances synced with Blockchain!');
    } catch (err) {
  ...
  if (isLoading || !user) return <div className="min-h-screen flex items-center justify-center"><Loader2 className="animate-spin text-purple-500" /></div>;
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="glass-card p-8 rounded-xl border border-white/5">
          <div className="space-y-8">
            ...
            {/* [FIX 3] Đã xóa phần Trading Preferences (Select Box) ở đây */}
