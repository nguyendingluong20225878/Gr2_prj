...
export const investmentsTable: Model<InvestmentSchema> =
  (mongoose.models.Investment as Model<InvestmentSchema>) ??
  mongoose.model<InvestmentSchema>("Investment", investmentSchema);
